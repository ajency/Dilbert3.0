...
@section('footer')
    ...
    <script type="text/javascript" src="{{ url('/views/summary/inline.js') }}"></script>
    <script type="text/javascript" src="{{ url('/views/summary/styles.bundle.js') }}"></script>
    <script type="text/javascript" src="{{ url('/views/summary/scripts.bundle.js') }}"></script>
    <script type="text/javascript" src="{{ url('/views/summary/main.bundle.js') }}"></script>
