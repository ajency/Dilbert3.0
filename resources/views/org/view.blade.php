        		...
        		<tbody>
        			@foreach($orgs as $org)
	        			<tr>
	        				...
	        				<td style="width:10%"> <a href="/orgs/delete/{{$org->id}}" class="btn btn-danger" onclick="confirmDel(this)" style="margin:0px"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> @lang('lang.delete')</a> </td>
	        			</tr>
        			@endforeach
        		</tbody>
        	</table>
